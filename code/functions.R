...
funcao_excel <- function(pais, caminho_output, df_base, description) {
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D16*Inputs!D2*Inputs!D44*Inputs!D19", startCol=3, startRow=2)
  # Fórmula 4: Dimensão 1 - Satellite service
  writeData(wb, sheet = "Results", x="dim_1_price_satellite_service", startCol=4, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D15*Inputs!D2*Inputs!D18*Inputs!D43", startCol=4, startRow=2)
  # Fórmula 5: Dimensão 1 - Fiber link
  writeData(wb, sheet = "Results", x="dim_1_price_fiber_link", startCol=5, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D14*Inputs!D2*Inputs!D12*(Inputs!D18/200)*Inputs!D43", startCol=5, startRow=2)
  # Fórmula 6: Dimensão 1 - Access point
  writeData(wb, sheet = "Results", x="dim_1_price_access_point", startCol=6, startRow=1)
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5/ 25)+Inputs!D8*3)+((Inputs!D6/35)+Inputs!D9*3))*Inputs!D45*Inputs!D20", startCol=6, startRow=2)
  # Fórmula 7: Dimensão 1 - Firewall
  writeData(wb, sheet = "Results", x="dim_1_price_firewall", startCol=7, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D46*Inputs!D21", startCol=7, startRow=2)
  # Fórmula 8: Dimensão 1 - Nobreak
  writeData(wb, sheet = "Results", x="dim_1_price_nobreak", startCol=8, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D47*Inputs!D22", startCol=8, startRow=2)
  # Fórmula 9: Dimensão 1 - Switch
  writeData(wb, sheet = "Results", x="dim_1_price_switch", startCol=9, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D48*Inputs!D23", startCol=9, startRow=2)
  # Fórmula 10: Dimensão 1 - Rack 6U/8U
  writeData(wb, sheet = "Results", x="dim_1_price_rack", startCol=10, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D49*Inputs!D24", startCol=10, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D5*Inputs!D50*Inputs!D29)+(Inputs!D6*Inputs!D51*Inputs!D31)", startCol=11, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D5*Inputs!D52*Inputs!D29)+(Inputs!D6*Inputs!D53*Inputs!D31)", startCol=12, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D5*Inputs!D54*Inputs!D29)+(Inputs!D6*Inputs!D55*Inputs!D31)", startCol=13, startRow=2)
  # Fórmula 14: Dimensão 2 - Devices per teacher 
  writeData(wb, sheet = "Results", x="dim_2_price_device_teacher", startCol=14, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D7*Inputs!D56*Inputs!D30", startCol=14, startRow=2)
  # Fórmula 15: Dimensão 2 - Devices per school 
  writeData(wb, sheet = "Results", x="dim_2_price_device_school", startCol=15, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D57*Inputs!D28", startCol=15, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D50)+(Inputs!D6*Inputs!D51))/30*Inputs!D27", startCol=16, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D52)+(Inputs!D6*Inputs!D53))/30*Inputs!D27", startCol=17, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D54)+(Inputs!D6*Inputs!D55))/30*Inputs!D27", startCol=18, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D58*Inputs!D25", startCol=19, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D50)+(Inputs!D6*Inputs!D51))*Inputs!D26", startCol=20, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D52)+(Inputs!D6*Inputs!D53))*Inputs!D26", startCol=21, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*Inputs!D54)+(Inputs!D6*Inputs!D55))*Inputs!D26", startCol=22, startRow=2)
  
  # Fórmula 23: Dimensão 3 - Diagnostic Tool
  writeData(wb, sheet = "Results", x="dim_3_price_diagnostic_tool", startCol=23, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D37", startCol=23, startRow=2)
  # Fórmula 24: Dimensão 3 - LMS Platform
  writeData(wb, sheet = "Results", x="dim_3_price_lms_platform", startCol=24, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D38", startCol=24, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D40*(Inputs!D36/Inputs!D59)", startCol=26, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D40*1.5*(Inputs!D36/Inputs!D59)/Inputs!D59", startCol=27, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D39", startCol=28, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D40*Inputs!D42", startCol=29, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D40*(Inputs!D36/Inputs!D59))*Inputs!D42", startCol=30, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D40*1.5*(Inputs!D36/Inputs!D59)/Inputs!D59)*Inputs!D42", startCol=31, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D39*Inputs!D42", startCol=32, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D40*Inputs!D42", startCol=33, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D40*(Inputs!D36/Inputs!D59))*Inputs!D41*Inputs!D42", startCol=34, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D40*1.5*(Inputs!D36/Inputs!D59)/Inputs!D59)*Inputs!D41*Inputs!D42", startCol=35, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D39*Inputs!D42", startCol=36, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6+Inputs!D5)*Inputs!D32*Inputs!D60*(Inputs!D43/12)", startCol=37, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D33*Inputs!D61*(Inputs!D43/12)", startCol=38, startRow=2)
  
  # Fórmula 39: Dimensão 5 - Central team
  writeData(wb, sheet = "Results", x="dim_5_price_central_team", startCol=39, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D34*((Inputs!D62+Inputs!D63)/2)*Inputs!D43", startCol=39, startRow=2)
  # Fórmula 40: Dimensão 5 - Regional team
  writeData(wb, sheet = "Results", x="dim_5_price_regional_team", startCol=40, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D64*Inputs!D2*Inputs!D35*Inputs!D43", startCol=40, startRow=2)
  # Fórmula 41: Dimensão 5 - Local team
  writeData(wb, sheet = "Results", x="dim_5_price_local_team", startCol=41, startRow=1)
  writeFormula(wb, sheet="Results", x="=(Inputs!D65*(Inputs!D2-Inputs!D3)+(Inputs!D66*Inputs!D3))*Inputs!D35*Inputs!D43", startCol=41, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D16*Inputs!D9*Inputs!D44*Inputs!D19", startCol=42, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D6*Inputs!D51*Inputs!D31", startCol=50, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D6*Inputs!D53*Inputs!D31", startCol=51, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D6*Inputs!D55*Inputs!D31", startCol=52, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D7*(Inputs!D6/(Inputs!D4)))*Inputs!D56*Inputs!D30", startCol=53, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D9*Inputs!D57*Inputs!D28", startCol=54, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D51)/30*Inputs!D27", startCol=55, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D53)/30*Inputs!D27", startCol=56, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D55)/30*Inputs!D27", startCol=57, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D9*Inputs!D58*Inputs!D25", startCol=58, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D51)*Inputs!D26", startCol=59, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D53)*Inputs!D26", startCol=60, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D6*Inputs!D55)*Inputs!D26", startCol=61, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D37", startCol=62, startRow=2)
  # Fórmula 94: Dimensão 3 - LMS Platform
  writeData(wb, sheet = "Results", x="sce1_sec_dim_3_price_lms_platform", startCol=63, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D38", startCol=63, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D40*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59)", startCol=65, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D35 *1.5*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59)/Inputs!D59", startCol=66, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D39", startCol=67, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D40)", startCol=68, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D40*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59))", startCol=69, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D35 *1.5*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59)/Inputs!D59)", startCol=70, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D39)", startCol=71, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D40)", startCol=72, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D41*Inputs!D42*(Inputs!D40*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59))", startCol=73, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D41*Inputs!D42*(Inputs!D35 *1.5*((Inputs!D36*(Inputs!D6/(Inputs!D4)))/Inputs!D59)/Inputs!D59)", startCol=74, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D39)", startCol=75, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D6*Inputs!D32*Inputs!D60*(Inputs!D43/12)", startCol=76, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D9*Inputs!D33*Inputs!D61*(Inputs!D43/12)", startCol=77, startRow=2)
  
  # Fórmula 109: Dimensão 5 - Central team
  writeData(wb, sheet = "Results", x="sce1_sec_dim_5_price_central_team", startCol=78, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D34*((Inputs!D62+Inputs!D63)/2)*Inputs!D43", startCol=78, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D64*Inputs!D9*Inputs!D35*Inputs!D43", startCol=79, startRow=2)
  # Fórmula 111: Dimensão 5 - Local team
  writeData(wb, sheet = "Results", x="sce1_sec_dim_5_price_local_team", startCol=80, startRow=1)
  writeFormula(wb, sheet="Results", x="=(Inputs!D65*(Inputs!D9/Inputs!D2)*(Inputs!D2-Inputs!D3)+(Inputs!D9/Inputs!D2)*(Inputs!D66*Inputs!D3))*Inputs!D35*Inputs!D43", startCol=80, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=MIN(Inputs!D3-MIN(Inputs!D3,(Inputs!D15*Inputs!D2)),Inputs!D16*Inputs!D2)*Inputs!D19*Inputs!D44", startCol=81, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=MIN(Inputs!D3,Inputs!D15*Inputs!D2)*Inputs!D18*Inputs!D43", startCol=82, startRow=2)
  # Fórmula 159: Dimensão 1 - Fiber link
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_fiber_link", startCol=83, startRow=1)
  writeFormula(wb, sheet="Results", x="=(Inputs!D3-MIN(Inputs!D3,Inputs!D15))*(Inputs!D12)*(Inputs!D18/200)*Inputs!D43", startCol=83, startRow=2)
  # Fórmula 160: Dimensão 1 - Access point
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_access_point", startCol=84, startRow=1)
  writeFormula(wb, sheet="Results", x="=((Inputs!D5/25)+Inputs!D8*3)+((Inputs!D6/35)+Inputs!D9*3)*(Inputs!D3/Inputs!D2)*Inputs!D45*Inputs!D20", startCol=84, startRow=2)
  # Fórmula 161: Dimensão 1 - Firewall
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_firewall", startCol=85, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D46*Inputs!D21", startCol=85, startRow=2)
  # Fórmula 162: Dimensão 1 - Nobreak
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_nobreak", startCol=86, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D47*Inputs!D22", startCol=86, startRow=2)
  # Fórmula 163: Dimensão 1 - Switch
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_switch", startCol=87, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D48*Inputs!D23", startCol=87, startRow=2)
  # Fórmula 164: Dimensão 1 - Rack 6U/8U
  writeData(wb, sheet = "Results", x="sce2_rur_dim_1_price_rack", startCol=88, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D49*Inputs!D24", startCol=88, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D50*Inputs!D29)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D51*Inputs!D31)", startCol=89, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D52*Inputs!D29)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D53*Inputs!D31)", startCol=90, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D54*Inputs!D29)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D55*Inputs!D31)", startCol=91, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(Inputs!D7*(Inputs!D3/Inputs!D2))*Inputs!D56*Inputs!D30", startCol=92, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D57*Inputs!D28", startCol=93, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D50)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D51))/30*Inputs!D27", startCol=94, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D52)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D53))/30*Inputs!D27", startCol=95, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D54)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D55))/30*Inputs!D27", startCol=96, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D58*Inputs!D25", startCol=97, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D50)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D51))*Inputs!D26", startCol=98, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D52)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D53))*Inputs!D26", startCol=99, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=(((Inputs!D5*(Inputs!D3/Inputs!D2))*Inputs!D54)+((Inputs!D6*(Inputs!D3/Inputs!D2))*Inputs!D55))*Inputs!D26", startCol=100, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D37", startCol=101, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D38", startCol=102, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D40*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59)", startCol=104, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D40*1.5*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59)/Inputs!D59", startCol=105, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D39", startCol=106, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D42*Inputs!D40", startCol=107, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D40*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59))", startCol=108, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*(Inputs!D40*1.5*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59)/Inputs!D59)", startCol=109, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*Inputs!D39", startCol=110, startRow=2)
  ...
  #writeFormula(wb, sheet="Results", x="=Inputs!D42*Inputs!D40", startCol=111, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D41*Inputs!D42*(Inputs!D40*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59))", startCol=112, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D41*Inputs!D42*(Inputs!D40*1.5*((Inputs!D36*(Inputs!D3/Inputs!D2))/Inputs!D59)/Inputs!D59)", startCol=113, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D42*Inputs!D39", startCol=114, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=((Inputs!D6+Inputs!D5)*(Inputs!D3/Inputs!D2))*Inputs!D32*Inputs!D60*(Inputs!D43/12)", startCol=115, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D3*Inputs!D33*Inputs!D61*(Inputs!D43/12)", startCol=116, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D34*((Inputs!D62+Inputs!D63)/2)*Inputs!D43", startCol=117, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D64*Inputs!D3*Inputs!D35*Inputs!D43", startCol=118, startRow=2)
  # Fórmula 185: Dimensão 5 - Local team
  writeData(wb, sheet = "Results", x="sce2_rur_dim_5_price_local_team", startCol=119, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D66*Inputs!D3*Inputs!D35*Inputs!D43", startCol=119, startRow=2)
  ...
  writeFormula(wb, sheet="Results", x="=Inputs!D7*Inputs!D56*Inputs!D30", startCol=120, startRow=2)
  # Fórmula 185: Dimensão 2: Apenas equipamentos para professores e escolas
  writeData(wb, sheet = "Results", x="sce3_devt_dim_2_price_device_school", startCol=121, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D57*Inputs!D28", startCol=121, startRow=2)
  # Fórmula 185: Dimensão 2: Apenas equipamentos para professores e escolas
  writeData(wb, sheet = "Results", x="sce3_devt_dim_2_price_multimedia_projector", startCol=122, startRow=1)
  writeFormula(wb, sheet="Results", x="=Inputs!D2*Inputs!D58*Inputs!D25", startCol=122, startRow=2)
  ...
  addStyle(wb, sheet="Inputs", num_style, rows = 2:66, cols = 4)
  ...
  addStyle(wb, sheet="Inputs", general_style, rows = 1:66, cols = 1)
  addStyle(wb, sheet="Inputs", general_style, rows = 1:66, cols = 2)
  addStyle(wb, sheet="Inputs", general_style, rows = 1:66, cols = 3)
